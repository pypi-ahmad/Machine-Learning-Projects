"""
Train — P18 Ball Tracking (YOLO)
===================================
Fine-tune YOLO26 for ball / sports-object detection & tracking.
...
def main():
    parser = argparse.ArgumentParser(description="P18 Ball Tracking — YOLO Fine-Tuning")
    ...
    train_detection(
        ...
        project=str(ROOT / "runs" / "detect"), name="ball_tracking",
        patience=args.patience, lr0=args.lr0, workers=args.workers,
        resume=args.resume,
        registry_project="ball_tracking",
    )
