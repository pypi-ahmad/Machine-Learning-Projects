...
def main() -> None:
    ap = argparse.ArgumentParser(description="Train Food Freshness Grader")
    ap.add_argument("--data", type=str, default=None,
                    help="Path to image-folder dataset")
    ap.add_argument("--model", type=str, default="resnet18",
                    help="resnet18|resnet50|efficientnet_b0|mobilenet_v2")
    ...
    save_dir = Path(__file__).parent / "runs" / "freshness_cls"
    ...
    stats = train_classification(
        ...
        registry_project="food_freshness_grader",
    )
