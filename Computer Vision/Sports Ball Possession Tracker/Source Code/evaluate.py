"""Evaluation script for Sports Ball Possession Tracker.

Runs YOLO ``val()`` on the sports detection dataset and prints
per-class metrics.

Usage::

    python evaluate.py
    python evaluate.py --model runs/sports_possession/train/weights/best.pt
"""
...
log = logging.getLogger("sports_possession.evaluate")


def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Evaluate sports detection model")
