...
Downloads and prepares a public medical document / prescription
dataset for testing and benchmarking the extraction pipeline.
...
def ensure_prescription_dataset(*, force: bool = False) -> Path:
    """Download and prepare the prescription dataset.
    ...
    -------
    Path
        The project data root (``data/prescription_ocr_parser/``).
    """
