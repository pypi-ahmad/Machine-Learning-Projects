"""Train Building Footprint Segmentation — YOLO segmentation.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Building Footprint Segmentation (YOLO-seg)")
    ...
    if args.data is None:
        data_path = DatasetResolver().resolve("building_footprint_seg", force=args.force_download)
    ...
    train_segmentation(
        ...
        registry_project="building_footprint_seg",
    )
