"""Train Road Segmentation for Autonomous Vehicles — YOLO segmentation.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Road Segmentation (YOLO-seg)")
    ...
    if args.data is None:
        data_path = DatasetResolver().resolve("road_segmentation", force=args.force_download)
    ...
    train_segmentation(
        ...
        name="road_seg",
        registry_project="road_segmentation",
    )
