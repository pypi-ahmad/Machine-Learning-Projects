"""Train Age & Gender Recognition — classification.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Age & Gender Recognition (classification)")
    ...
    train_classification(
        ...
        lr=args.lr,
        device=args.device,
        save_path=str(Path(__file__).parent / "runs" / "age_gender_cls" / "best_model.pt"),
        registry_project="age_gender_recognition",
    )
