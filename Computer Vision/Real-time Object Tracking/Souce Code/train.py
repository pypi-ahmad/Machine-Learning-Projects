"""Train object tracker — YOLO detection (tracking uses detection weights).
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Object Tracking detector (YOLO)")
    ...
    if args.data is None:
        data_path = DatasetResolver().resolve("realtime_object_tracking", force=args.force_download)
    ...
    train_detection(
        ...
        name="object_tracking_detect",
        registry_project="realtime_object_tracking",
    )
