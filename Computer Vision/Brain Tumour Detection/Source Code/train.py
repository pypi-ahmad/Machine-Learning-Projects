"""Train Brain Tumour Detection — classification (binary: tumour / no tumour).
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Brain Tumour Detection (classification)")
    ...
    train_classification(
        ...
        lr=args.lr,
        device=args.device,
        save_path=str(Path(__file__).parent / "runs" / "brain_tumour_cls" / "best_model.pt"),
        registry_project="brain_tumour_detection",
    )
