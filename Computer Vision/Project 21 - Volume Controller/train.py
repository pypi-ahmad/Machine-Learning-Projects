"""
Train — P21 Volume Controller (YOLO-Pose)
============================================
Fine-tune YOLO26-Pose for hand detection/keypoints.
...
def main():
    parser = argparse.ArgumentParser(description="P21 Volume Controller — YOLO-Pose Fine-Tuning")
    ...
    train_pose(args.data, args.model, args.epochs, args.imgsz, args.batch,
               args.device, str(ROOT / "runs" / "pose"), "hand_volume",
               args.patience, args.lr0, args.workers, args.resume,
               registry_project="volume_controller")
