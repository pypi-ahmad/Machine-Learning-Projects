...
# Add repo root and Source Code dir to path
...
class FilePaths:
    ...
    fn_char_list = str(_src_root / 'model' / 'charList.txt')
    fn_summary = str(_src_root / 'model' / 'summary.json')
    fn_corpus = str(_src_root / 'data' / 'corpus.txt')
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--img_file', help='Image used for inference.', type=Path, default=Path('data') / 'line.png')
