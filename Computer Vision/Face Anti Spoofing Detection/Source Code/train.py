...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Face Anti-Spoofing (classification)")
    ...
    train_classification(
        ...
        lr=args.lr,
        device=args.device,
        save_path=str(Path(__file__).parent / "runs" / "face_anti_spoof_cls" / "best_model.pt"),
        registry_project="face_anti_spoofing",
    )
