"""Modern registry entry for Gaze Direction Estimator.
...
@register("gaze_direction_estimator")
class GazeDirectionModern(CVProject):
    """Coarse gaze direction estimation from iris landmarks."""
    ...
    def load(self) -> None:
        ...
        self.cfg = GazeConfig()
        self._pipeline = GazePipeline(self.cfg)
        self._pipeline.load()
        self._validator = GazeValidator(self.cfg)
        self._loaded = True
    ...
    def predict(self, input_data, **kwargs):
        ...
        if isinstance(input_data, np.ndarray):
            ...
            return {
                ...
                "h_ratio": result.raw_gaze.h_ratio,
                "v_ratio": result.raw_gaze.v_ratio,
    ...
    def setup(self, **kwargs) -> None:
        ...
        self.cfg = (
            load_config(config_path) if config_path else GazeConfig()
        )
        self._pipeline = GazePipeline(self.cfg)
        self._pipeline.load()
        self._validator = GazeValidator(self.cfg)
