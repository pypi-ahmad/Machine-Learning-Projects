...
Downloads and prepares a public gaze/face-landmark dataset
from Hugging Face for evaluating the gaze pipeline.

Usage::

    from data_bootstrap import ensure_gaze_dataset

    data_root = ensure_gaze_dataset()            # idempotent
    data_root = ensure_gaze_dataset(force=True)  # force
"""
