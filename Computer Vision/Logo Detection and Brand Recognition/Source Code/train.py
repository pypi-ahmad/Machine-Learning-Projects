"""Train Logo Detection & Brand Recognition — classification (27 brands).
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Logo Detection (classification)")
    ...
    if args.data is None:
        data_path = DatasetResolver().resolve("logo_detection", force=args.force_download)
    ...
    train_classification(
        ...
        lr=args.lr,
        device=args.device,
        save_path=str(Path(__file__).parent / "runs" / "logo_cls" / "best_model.pt"),
