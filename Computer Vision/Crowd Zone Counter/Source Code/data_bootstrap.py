...
Downloads and prepares a public person/crowd detection dataset
...
def ensure_crowd_dataset(*, force: bool = False) -> Path:
    """Download and prepare the crowd/person detection dataset.
    ...
    -------
    Path
        The project data root (``data/crowd_zone_counter/``).
    """
