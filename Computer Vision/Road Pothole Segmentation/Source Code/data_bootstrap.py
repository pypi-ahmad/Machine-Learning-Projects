"""Road Pothole Segmentation — idempotent dataset bootstrap."""
...
PROJECT_KEY = "road_pothole_segmentation"
...
def ensure_pothole_dataset(force: bool = False) -> Path:
    """Download and prepare the pothole dataset (idempotent).
...
def _collect_media(raw_dir: Path, media_dir: Path) -> None:
    """Copy images from raw download into processed/media/."""
...
if __name__ == "__main__":
    ...
    path = ensure_pothole_dataset(force=force)
