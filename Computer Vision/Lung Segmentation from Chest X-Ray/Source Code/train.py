"""Train Lung Segmentation from Chest X-Ray — YOLO segmentation.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Lung Segmentation (YOLO-seg)")
    ...
    if args.data is None:
        data_path = DatasetResolver().resolve("lung_segmentation", force=args.force_download)
    ...
    train_segmentation(
        ...
        name="lung_seg",
        registry_project="lung_segmentation",
    )
