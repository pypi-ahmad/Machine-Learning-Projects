"""Exercise Rep Counter -- idempotent dataset bootstrap."""
...
PROJECT_KEY = "exercise_rep_counter"
...
def _collect_media(raw_dir: Path, media_dir: Path) -> None:
    """Copy images and videos from raw download into processed/media/."""
...
if __name__ == "__main__":
    ...
    path = ensure_exercise_dataset(force=force)
