"""Train Sign Language Recognition — YOLO pose estimation.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Sign Language Recognition (YOLO-pose)")
    ...
    if args.data is None:
        data_path = DatasetResolver().resolve("sign_language_recognition", force=args.force_download)
    ...
    train_pose(
        ...
        name="sign_language_pose",
        registry_project="sign_language_recognition",
    )
