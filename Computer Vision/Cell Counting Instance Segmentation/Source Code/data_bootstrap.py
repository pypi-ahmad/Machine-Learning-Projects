"""Cell Counting Instance Segmentation — idempotent dataset bootstrap."""
...
PROJECT_KEY = "cell_counting_instance_segmentation"
...
def ensure_cell_dataset(force: bool = False) -> Path:
    """Download and prepare the cell nuclei segmentation dataset (idempotent).
...
def _collect_media(raw_dir: Path, media_dir: Path) -> None:
    """Copy cell images from raw download into processed/media/."""
...
if __name__ == "__main__":
    ...
    path = ensure_cell_dataset(force=force)
