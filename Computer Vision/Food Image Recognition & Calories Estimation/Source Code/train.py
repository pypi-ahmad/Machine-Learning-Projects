...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Food Image Recognition (classification)")
    ...
    train_classification(
        ...
        lr=args.lr,
        device=args.device,
        save_path=str(Path(__file__).parent / "runs" / "food_image_cls" / "best_model.pt"),
        registry_project="food_image_recognition",
    )
