"""Validation rules for Invoice Field Extractor.
...
Usage::
    ...
    validator = InvoiceValidator(InvoiceConfig())
...
class InvoiceValidator:
    """Validate parsed invoice fields against configurable rules."""
    ...
    def _check_missing(self, result: ParseResult, report: ValidationReport) -> None:
        ...
        for fname in self.cfg.required_fields:
            if fname not in result.fields:
                ...
                sev = "error" if fname in ("invoice_number", "total") else "warning"
    ...
    def _check_confidence(self, result: ParseResult, report: ValidationReport,
    ...
    def _check_total_consistency(self, result: ParseResult, report: ValidationReport) -> None:
    ...
    def _check_date_format(self, result: ParseResult, report: ValidationReport) -> None:
        for dname in ("invoice_date", "due_date"):
