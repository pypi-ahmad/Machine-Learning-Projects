"""Train pedestrian detector — YOLO detection.
"""Train pedestrian detector — YOLO detection.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Pedestrian Detection (YOLO)")
    ...
    if args.data is None:
        data_path = DatasetResolver().resolve("pedestrian_detection", force=args.force_download)
    ...
    train_detection(
        ...
        registry_project="pedestrian_detection",
    )
