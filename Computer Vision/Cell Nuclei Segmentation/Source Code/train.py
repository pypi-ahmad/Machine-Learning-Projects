"""Train Cell Nuclei Segmentation — YOLO segmentation.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Cell Nuclei Segmentation (YOLO-seg)")
    ...
    train_segmentation(
        ...
        registry_project="cell_nuclei_seg",
    )
