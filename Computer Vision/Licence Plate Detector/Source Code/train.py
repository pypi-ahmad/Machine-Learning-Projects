"""Train licence-plate detector — YOLO detection.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Licence Plate Detector (YOLO)")
    ...
    if args.data is None:
        data_path = DatasetResolver().resolve("licence_plate_detector", force=args.force_download)
    ...
    train_detection(
        ...
        name="licence_plate_detect",
        registry_project="licence_plate_detector",
    )
