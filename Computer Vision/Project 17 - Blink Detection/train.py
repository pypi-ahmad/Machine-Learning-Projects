"""
Train — P17 Blink Detection (YOLO-Pose)
==========================================
Fine-tune YOLO26-Pose for face/eye keypoint detection (blink EAR).
...
def main():
    parser = argparse.ArgumentParser(description="P17 Blink Detection — YOLO-Pose Fine-Tuning")
    ...
    train_pose(args.data, args.model, args.epochs, args.imgsz, args.batch,
               args.device, str(ROOT / "runs" / "pose"), "blink_detect",
               args.patience, args.lr0, args.workers, args.resume,
               registry_project="blink_detection")
