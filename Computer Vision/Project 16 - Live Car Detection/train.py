"""
Train — P16 Car Detection (YOLO)
===================================
Fine-tune YOLO26 for vehicle detection (car, bus, truck).
...
def main():
    parser = argparse.ArgumentParser(description="P16 Car Detection — YOLO Fine-Tuning")
    ...
    train_detection(
        ...
        project=str(ROOT / "runs" / "detect"), name="car_detect",
        patience=args.patience, lr0=args.lr0, workers=args.workers,
        resume=args.resume,
        registry_project="car_detection",
    )
