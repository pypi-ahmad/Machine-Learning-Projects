"""
Train — P06 Hand Tracking (YOLO-Pose)
========================================
Fine-tune YOLO26-Pose for hand landmark detection.

Provide a YOLO-Pose data.yaml with hand keypoint annotations.

Usage::

    python train.py --data path/to/hand_pose_data.yaml
"""
...
def main():
    parser = argparse.ArgumentParser(description="P06 HTM — YOLO-Pose Fine-Tuning")
    ...
    train_pose(args.data, args.model, args.epochs, args.imgsz, args.batch,
               args.device, str(ROOT / "runs" / "pose"), "hand_tracking",
               args.patience, args.lr0, args.workers, args.resume,
               registry_project="hand_tracking")
