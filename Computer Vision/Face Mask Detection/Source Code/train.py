"""Train face-mask detector — YOLO detection.
"""Train face-mask detector — YOLO detection.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Face Mask Detection (YOLO)")
    ...
    if args.data is None:
        data_path = DatasetResolver().resolve("face_mask_detection", force=args.force_download)
    ...
    train_detection(
        ...
        name="face_mask_detect",
        registry_project="face_mask_detection",
    )
