...
This project uses EasyOCR (pre-trained) and OpenCV-based checkbox
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.data is None:
        data_path = ensure_form_dataset(force=args.force_download)
    ...
    print("[INFO] EasyOCR is pre-trained; evaluating checkbox + OCR on form images.")
