...
from Hugging Face for testing the clustering pipeline.

Usage::

    from data_bootstrap import ensure_face_cluster_dataset

    data_root = ensure_face_cluster_dataset()            # idempotent
    data_root = ensure_face_cluster_dataset(force=True)  # force
"""
