"""Conveyor Part Defect Detector — evaluation harness.
...
log = logging.getLogger("conveyor_defect.evaluate")


def main() -> None:
    parser = argparse.ArgumentParser(description="Conveyor Part Defect Detector — Evaluation")
