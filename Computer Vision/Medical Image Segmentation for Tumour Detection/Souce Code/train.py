"""Train Medical Image Segmentation for Tumour Detection — YOLO segmentation.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Medical Image Segmentation (YOLO-seg)")
    ...
    if args.data is None:
        data_path = DatasetResolver().resolve("medical_image_seg", force=args.force_download)
    ...
    train_segmentation(
        ...
        name="medical_image_seg",
        registry_project="medical_image_seg",
    )
