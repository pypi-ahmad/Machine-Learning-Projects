"""
Train — P49 Text Detection (YOLO)
====================================
Fine-tune YOLO26 for text region detection.
...
def main():
    parser = argparse.ArgumentParser(description="P49 Text Detection — YOLO Fine-Tuning")
    ...
    train_detection(
        ...
        project=str(ROOT / "runs" / "detect"), name="text_detect",
        patience=args.patience, lr0=args.lr0, workers=args.workers,
        resume=args.resume,
        registry_project="text_detection",
    )
