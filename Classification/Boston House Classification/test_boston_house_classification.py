"""
Auto-generated tests for: Classification/Boston House Classification
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/boston_house_classification/HousingData.csv")
...
class TestPrediction:
    ...
    def test_prediction_classes_valid(self):
        ...
        # LinearRegression produces continuous values; verify finite & reasonable range
