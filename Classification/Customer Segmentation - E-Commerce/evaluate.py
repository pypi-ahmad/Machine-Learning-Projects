#!/usr/bin/env python3
"""
Model evaluation for Customer segmentation for an E-commerce company
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Model evaluation for Customer segmentation for an E-commerce company")
