"""
Auto-generated tests for: Classification/Customer segmentation for an E-commerce company
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/customer_segmentation_ecommerce/data.csv")
...
class TestPrediction:
    ...
    def test_prediction_classes_valid(self):
        ...
        # KMeans cluster labels are non-negative integers
