"""
Auto-generated tests for: Classification/Mobile price classification
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/mobile_price_classification/train.csv")
