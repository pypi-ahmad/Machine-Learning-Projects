"""
Auto-generated tests for: Classification/Predicting loan default
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/loan_default_prediction/Loan_Default.csv")
