"""
Auto-generated tests for: Classification/Movie Genre Classification
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/movie_genre_classification/Genre Classification Dataset/test_data_solution.txt")

def load_data(nrows=None):
    """Load the primary dataset."""
    kwargs = dict(filepath_or_buffer=DATA_PATH, sep=' ::: ', engine='python', header=None, names=['id', 'title', 'genre', 'description'])
    if nrows:
        kwargs["nrows"] = nrows
    try:
