"""
Auto-generated tests for: Classification/Predicting customer lifetime value
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/customer_lifetime_value/data.csv")
