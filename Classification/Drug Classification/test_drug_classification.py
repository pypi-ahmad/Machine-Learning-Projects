"""
Auto-generated tests for: Classification/Drug Classification
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/drug_classification/drugsComTrain_raw.csv")
