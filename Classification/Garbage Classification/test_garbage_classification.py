"""
Auto-generated tests for: Classification/Garbage Classification
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/garbage_classification/one-indexed-files.txt")
...
class TestPreprocessing:
    ...
    def test_numeric_columns_exist(self):
        df = load_data(nrows=100)
        # Image/file-list datasets may have no numeric columns; verify columns exist at all
        assert len(df.columns) > 0, "Dataset has no columns"
