"""
Auto-generated tests for: Classification/Student performance prediction
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/student_performance/StudentsPerformance.csv")
