"""
Auto-generated tests for: Classification/Traffic Congestion Prediction
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/traffic_congestion_prediction/traffic.csv")
