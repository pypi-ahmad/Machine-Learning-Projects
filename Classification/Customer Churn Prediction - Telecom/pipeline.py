#!/usr/bin/env python3
"""
Full pipeline for Predicting customer churn for a telecom company
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Full pipeline for Predicting customer churn for a telecom company")
