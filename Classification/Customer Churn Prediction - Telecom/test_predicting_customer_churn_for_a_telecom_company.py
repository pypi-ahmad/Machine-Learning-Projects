"""
Auto-generated tests for: Classification/Predicting customer churn for a telecom company
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/customer_churn_telecom/telecom_customer_churn.csv")
