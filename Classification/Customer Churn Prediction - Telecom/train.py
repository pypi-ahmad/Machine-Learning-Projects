#!/usr/bin/env python3
"""
Model training for Predicting customer churn for a telecom company
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Model training for Predicting customer churn for a telecom company")
