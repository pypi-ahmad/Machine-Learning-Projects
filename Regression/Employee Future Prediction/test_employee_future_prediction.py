"""
Auto-generated tests for: Regression/Employee Future Prediction
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/employee_future_prediction/Employee.csv")
