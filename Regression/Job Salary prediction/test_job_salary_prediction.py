"""
Auto-generated tests for: Regression/Job Salary prediction
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/job_salary_prediction/adzuna_global_job_listings_2025.csv")
