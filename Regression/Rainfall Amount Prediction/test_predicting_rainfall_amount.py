"""
Auto-generated tests for: Regression/Predicting rainfall amount
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/rainfall_prediction/weatherAUS.csv")
