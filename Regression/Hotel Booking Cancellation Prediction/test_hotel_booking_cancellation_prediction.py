"""
Auto-generated tests for: Regression/Hotel Booking Cancellation Prediction
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/hotel_booking_cancellation/hotel_bookings.csv")
