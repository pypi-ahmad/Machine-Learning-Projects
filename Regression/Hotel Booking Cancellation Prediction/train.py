#!/usr/bin/env python3
"""
Model training for Hotel Booking Cancellation Prediction
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Model training for Hotel Booking Cancellation Prediction")
