"""
Auto-generated tests for: Regression/Bank Customer churn prediction
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/bank_customer_churn/Churn_Modelling.csv")
