...
def load_data():
    df = pd.read_csv("https://raw.githubusercontent.com/dsrscientist/dataset1/master/ipl_data.csv", sep=",")
...
def train_and_evaluate(X_train, X_test, y_train, y_test):
    ...
    try:
        ...
        import tempfile
        train_ag = X_train.copy(); train_ag["total"] = y_train.values
        with tempfile.TemporaryDirectory() as tmp:
            predictor = TabularPredictor(label="total", path=tmp, problem_type="regression", verbosity=1)
