"""
Auto-generated tests for: Regression/Stock price prediction
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/stock_price_prediction_netflix/NFLX.csv")
