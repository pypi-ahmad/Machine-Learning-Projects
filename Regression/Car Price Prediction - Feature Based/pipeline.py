#!/usr/bin/env python3
"""
Full pipeline for Predicting car prices using the car features
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Full pipeline for Predicting car prices using the car features")
