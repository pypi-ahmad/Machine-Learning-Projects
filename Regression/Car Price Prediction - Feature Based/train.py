#!/usr/bin/env python3
"""
Model training for Predicting car prices using the car features
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Model training for Predicting car prices using the car features")
