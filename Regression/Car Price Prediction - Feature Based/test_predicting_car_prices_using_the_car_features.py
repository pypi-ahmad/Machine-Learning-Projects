"""
Auto-generated tests for: Regression/Predicting car prices using the car features
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/car_price_prediction/CarPrice_Assignment.csv")
