"""
Auto-generated tests for: Regression/Prediction Future Sales
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/future_sales_prediction/Walmart_Sales.csv")
