"""
Auto-generated tests for: Regression/Predicting diabetes using the prima indians diabetes dataset
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/indians_diabetes_da/data.csv")
