#!/usr/bin/env python3
"""
Model evaluation for Predicting diabetes using the prima indians diabetes dataset
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Model evaluation for Predicting diabetes using the prima indians diabetes dataset")
