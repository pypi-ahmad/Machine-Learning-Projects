"""
Auto-generated tests for: Regression/Insurance premium prediction
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/insurance_premium_prediction/insurance.csv")
