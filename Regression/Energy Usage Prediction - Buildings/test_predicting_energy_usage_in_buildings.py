"""
Auto-generated tests for: Regression/Predicting energy usage in buildings
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/energy_usage_prediction/KAG_energydata_complete.csv")
