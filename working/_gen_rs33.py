...
notebook = {
    "cells": [
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-001", "language": "markdown"},
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-002", "language": "markdown"},
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-003", "language": "markdown"},
            "source": [
                "## Environment Setup"
            ]
        },
        {
            "cell_type": "code",
            "metadata": {"id": "rs33-004", "language": "python"},
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-005", "language": "markdown"},
            "source": [
        ...
        {
            "cell_type": "code",
            "metadata": {"id": "rs33-006", "language": "python"},
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-007", "language": "markdown"},
            "source": [
        ...
        {
            "cell_type": "code",
            "metadata": {"id": "rs33-008", "language": "python"},
            "source": [
                "import kagglehub\n",
                "\n",
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-009", "language": "markdown"},
            "source": [
        ...
        {
            "cell_type": "code",
            "metadata": {"id": "rs33-010", "language": "python"},
            "source": [
        ...
        {
            "cell_type": "code",
            "metadata": {"id": "rs33-011", "language": "python"},
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-012", "language": "markdown"},
            "source": [
        ...
        {
            "cell_type": "code",
            "metadata": {"id": "rs33-013", "language": "python"},
            "source": [
        ...
        {
            "cell_type": "code",
            "metadata": {"id": "rs33-014", "language": "python"},
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-015", "language": "markdown"},
            "source": [
                "## Train YOLO26m-seg"
            ]
        },
        {
            "cell_type": "code",
            "metadata": {"id": "rs33-016", "language": "python"},
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-017", "language": "markdown"},
            "source": [
                "## Real Evaluation"
            ]
        },
        {
            "cell_type": "code",
            "metadata": {"id": "rs33-018", "language": "python"},
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-019", "language": "markdown"},
            "source": [
        ...
        {
            "cell_type": "code",
            "metadata": {"id": "rs33-020", "language": "python"},
            "source": [
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-021", "language": "markdown"},
            "source": [
                "## Save Real Outputs"
            ]
        },
        {
            "cell_type": "code",
            "metadata": {"id": "rs33-022", "language": "python"},
            "source": [
                "metrics = {\n",
        ...
        {
            "cell_type": "markdown",
            "metadata": {"id": "rs33-023", "language": "markdown"},
            "source": [
                "## Limitations\n",
                "\n",
...
out_path = Path(r'e:\Github\Machine-Learning-Projects\Computer Vision\Road Segmentation for Autonomous Vehicles\Souce Code\road_segmentation_pipeline.ipynb')
