"""Tests for NLP Projects 32 - Text Summarization using Word Frequency (no local data files)."""
import pytest
...
def project_dir():
    ...
    return root / "NLP Projects 32 - Text Summarization using Word Frequency"
