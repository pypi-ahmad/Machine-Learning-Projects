"""Tests for NLP Projects 28 - Build_Sentiment_Analysis_Flask_Web_App (no local data files)."""
import pytest
...
def project_dir():
    ...
    return root / "NLP Projects 28 - Build_Sentiment_Analysis_Flask_Web_App"
