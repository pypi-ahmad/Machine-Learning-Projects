"""Tests for NLP Projects 24 - Hillary Clinton and Donald Trump Tweets"""
import pytest
import pandas as pd
import numpy as np
import re
...
def data_dir():
    ...
    d = root / "data" / "NLP Projects 24 - Hillary Clinton and Donald Trump Tweets"
    if not d.exists():
...
class TestModel:
    ...
    def test_model_fit(self, df):
        ...
        subset = df[["text", "handle"]].dropna().head(200)
        vec = TfidfVectorizer(max_features=100)
