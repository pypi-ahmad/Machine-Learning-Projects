"""
Auto-generated tests for: Time Series Analysis/Store Item Demand Forecasting
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/store_item_demand_forecasting/train.csv")
