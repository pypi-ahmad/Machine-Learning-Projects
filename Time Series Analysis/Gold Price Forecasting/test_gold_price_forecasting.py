"""
Auto-generated tests for: Time Series Analysis/Gold Price Forecasting
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/gold_price_forecasting/data.csv")
