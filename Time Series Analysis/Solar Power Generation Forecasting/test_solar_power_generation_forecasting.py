"""
Auto-generated tests for: Time Series Analysis/Solar Power Generation Forecasting
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "data/Plant_2_Generation_Data.csv")
