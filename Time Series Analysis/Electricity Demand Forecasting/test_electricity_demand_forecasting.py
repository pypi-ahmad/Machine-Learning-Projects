"""
Auto-generated tests for: Time Series Analysis/Electricity Demand Forecasting
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/electricity_demand_forecasting/data.csv")

def load_data(nrows=None):
    """Load the primary dataset."""
    kwargs = dict(filepath_or_buffer=DATA_PATH, sep=',')
    if nrows:
        kwargs["nrows"] = nrows
    try:
