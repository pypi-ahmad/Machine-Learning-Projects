"""
Auto-generated tests for: Time Series Analysis/Stock Price Forecasting
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/stock_price_forecasting_ts/stock_data_combined.csv")
