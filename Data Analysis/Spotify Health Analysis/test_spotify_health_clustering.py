"""
Auto-generated tests for: Data Analysis/Spotify Health Clustering
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/spotify_health_clustering/train.csv")
