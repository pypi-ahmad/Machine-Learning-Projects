#!/usr/bin/env python3
"""
Model evaluation for Customer Lifetime Value Prediction
...
def main():
    ...
    tx_data = load_dataset('customer_lifetime_value_prediction')
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Model evaluation for Customer Lifetime Value Prediction")
