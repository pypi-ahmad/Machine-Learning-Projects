"""
Auto-generated tests for: Data Analysis/COVID-19 Global Data Analysis
Task type: analysis
"""
import pytest
import pandas as pd
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "data/worldometer_coronavirus_daily_data.csv")
