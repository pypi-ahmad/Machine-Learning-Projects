#!/usr/bin/env python3
"""
Model evaluation for Student Alcohol Consumption Analysis
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Model evaluation for Student Alcohol Consumption Analysis")
