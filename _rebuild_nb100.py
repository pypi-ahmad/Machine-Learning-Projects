"""Rebuild notebook 100 from scratch with proper JSON structure."""
import json
...
nb = {
    "cells": [
        {"cell_type": "markdown", "metadata": {}, "source": [
            ...
            "\n",
            "**What you'll learn:**\n",
            "- Integrate conversational AI, RAG, tool use, structured output, evaluation, and observability into one local platform\n",
            "- Combine techniques from all 99 previous projects into a unified architecture\n",
            "\n",
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## Module 1 \u2014 Core LLM & Embeddings"]},
        {"cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [], "source": [
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## Module 2 \u2014 Knowledge Base (RAG)"]},
        {"cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [], "source": [
            "# Build a knowledge base from the project documentation\n",
            "knowledge_docs = [\n",
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## Module 3 \u2014 Tool Registry"]},
        {"cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [], "source": [
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## Module 4 \u2014 Evaluation Engine"]},
        {"cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [], "source": [
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## Module 5 \u2014 Integrated Pipeline"]},
        {"cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [], "source": [
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## Module 6 \u2014 Run the Platform"]},
        {"cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [], "source": [
            "queries = [\n",
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## Module 7 \u2014 Platform Dashboard"]},
        {"cell_type": "code", "execution_count": None, "metadata": {}, "outputs": [], "source": [
            "import pandas as pd\n",
            "\n",
            "# Performance summary\n",
...
path = r'E:\Github\Machine-Learning-Projects\100_Local_AI_Projects\Coding_and_Developer_Agents\100_Local_AI_Ops_Mini_Platform\notebook.ipynb'
with open(path, 'w', encoding='utf-8', newline='\n') as f:
    json.dump(nb, f, indent=1, ensure_ascii=False)
    f.write('\n')
print(f'Built: {len(nb["cells"])} cells')
