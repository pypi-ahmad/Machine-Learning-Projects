"""
Tests for: Machine Learning Projects 158 - Tesla Car Price Prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "tesla_car_price_prediction"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "CarPrice_Assignment.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "CarPrice_Assignment.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "CarPrice_Assignment.csv", encoding="latin-1")
