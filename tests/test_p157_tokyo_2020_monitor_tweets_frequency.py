"""
Tests for: Machine Learning Projects 157 - Tokyo 2020 Monitor Tweets Frequency
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "tokyo_2020_monitor_tweets_frequency"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "tokyo_2020_tweets.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "tokyo_2020_tweets.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "tokyo_2020_tweets.csv", encoding="latin-1")
