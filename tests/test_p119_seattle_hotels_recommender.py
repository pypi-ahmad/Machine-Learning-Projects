"""
Tests for: Machine Learning Projects 119 - Seattle Hotels Recommender
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "seattle_hotels_recommender"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Seattle_Hotels.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "Seattle_Hotels.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "Seattle_Hotels.csv", encoding="latin-1")
