"""
Tests for: Machine Learning Project 2 - Bitcoin Price Prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "bitcoin_price_prediction"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "bitcoin.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "bitcoin.csv", encoding="latin-1")
