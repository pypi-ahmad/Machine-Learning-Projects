"""
Tests for: Machine Learning Projects 136 - Collaborative Filtering Model with TensorFlow
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "collaborative_filtering_model_with_tensorflow"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "BX-Book-Ratings.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "BX-Book-Ratings.csv", sep=";", encoding="latin-1", on_bad_lines="skip")
