"""
Tests for: Machine Learning Projects 123 - (Conceptual) Supervised Learning - Part II
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "conceptual_supervised_learning_-_part_ii"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "fruit_data_with_colors.txt"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "fruit_data_with_colors.txt")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "fruit_data_with_colors.txt", encoding="latin-1")
...
class TestModelTraining:
    ...
    def test_gradientboostingclassifier_fit(self):
