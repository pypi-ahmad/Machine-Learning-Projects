"""
Tests for: Machine Learning Project 17 - Flight Fare Prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "flight_fare_prediction"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Data_Train.xlsx"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_excel(DATA_DIR / "Data_Train.xlsx", encoding="latin-1")
