"""
Tests for: Machine Learning Projects 133 - Building Recommender system with surpise
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "building_recommender_system_with_surpise"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "BX-Users.csv", sep=";", encoding="latin-1", on_bad_lines="skip")
