"""
Tests for: Machine Learning Project 25 - Advanced Credit Card fraud Detection
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "advanced_credit_card_fraud_detection"
pytestmark = []
