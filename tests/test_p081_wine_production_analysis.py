"""
Tests for: Machine Learning Projects 81 - Wine Production Analysis
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "wine_production_analysis"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Wine_Production_by_country.xlsx"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_excel(DATA_DIR / "Wine_Production_by_country.xlsx")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_excel(DATA_DIR / "Wine_Production_by_country.xlsx", encoding="latin-1")
