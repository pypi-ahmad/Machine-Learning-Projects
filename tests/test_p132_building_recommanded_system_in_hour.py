"""
Tests for: Machine Learning Projects 132 -  Building Recommanded system in hour
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "building_recommanded_system_in_hour"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "BX-Books.csv", sep=";", encoding="latin-1", on_bad_lines="skip")
