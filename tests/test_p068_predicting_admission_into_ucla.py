"""
Tests for: Machine Learning Project 68 - Predicting Admission into UCLA
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "predicting_admission_into_ucla"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "admission_predict.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "admission_predict.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "admission_predict.csv", encoding="latin-1")
