"""
Tests for: Machine Learning Project 9 - (HealthCare) Heart_Disease Prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "healthcare_heart_disease_prediction"
pytestmark = []
