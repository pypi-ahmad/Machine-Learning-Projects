"""
Tests for: Machine Learning Project 35 - Spam Classifier
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "spam_classifier"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "SMSSpamCollection"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "SMSSpamCollection")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "SMSSpamCollection", encoding="latin-1")
