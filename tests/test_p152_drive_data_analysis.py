"""
Tests for: Machine Learning Projects 152 - Drive Data Analysis
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "drive_data_analysis"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "2018-19_AutonomousVehicleDisengagementReports(firsttimefilers).csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "2018-19_AutonomousVehicleDisengagementReports(firsttimefilers).csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "2018-19_AutonomousVehicleDisengagementReports(firsttimefilers).csv", encoding="latin-1")
