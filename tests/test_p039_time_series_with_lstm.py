"""
Tests for: Machine Learning Project 39 - TIme Series With LSTM
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "time_series_with_lstm"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "airline-passengers.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "airline-passengers.csv", encoding="latin-1")
