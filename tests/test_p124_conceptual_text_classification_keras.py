"""
Tests for: Machine Learning Projects 124 - (Conceptual) Text Classification Keras
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "conceptual_text_classification_keras"
pytestmark = []
