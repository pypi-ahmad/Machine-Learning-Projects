"""
Tests for: Machine Learning Projects 80 - Mall Customer Segmentation Data
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "mall_customer_segmentation_data"
pytestmark = []
