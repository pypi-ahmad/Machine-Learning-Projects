"""
Tests for: Machine Learning Projects 76 - Titanic Dataset - Exploratory Analysis
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "titanic_dataset_-_exploratory_analysis"
pytestmark = []
