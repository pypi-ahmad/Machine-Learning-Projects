"""
Tests for: Machine Learning Projects 127 - TPOT Mercedes
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "tpot_mercedes"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "mercedesbenz.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "mercedesbenz.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "mercedesbenz.csv", encoding="latin-1")
