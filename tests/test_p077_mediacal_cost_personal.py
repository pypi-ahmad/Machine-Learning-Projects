"""
Tests for: Machine Learning Projects 77 - Mediacal Cost Personal
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "mediacal_cost_personal"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "insurance.csv", encoding="latin-1")
