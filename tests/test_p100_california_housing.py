"""
Tests for: Machine Learning Projects 100 - California Housing
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "california_housing"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "california_housing_train.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "california_housing_train.csv", encoding="latin-1")
