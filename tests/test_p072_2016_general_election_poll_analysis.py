"""
Tests for: Machine Learning Projects 72 - 2016 General Election Poll Analysis
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "2016_general_election_poll_analysis"
pytestmark = []
