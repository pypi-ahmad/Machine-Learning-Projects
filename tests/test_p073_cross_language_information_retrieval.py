"""
Tests for: Machine Learning Projects 73 - Cross Language Information Retrieval
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "cross_language_information_retrieval"
pytestmark = []
