"""
Tests for: Machine Learning Projects 128 - Weather Data Classification using Decision Trees
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "weather_data_classification_using_decision_trees"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "daily_weather.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "daily_weather.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "daily_weather.csv", encoding="latin-1")
