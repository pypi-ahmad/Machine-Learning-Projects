"""
Tests for: Machine Learning Project 47 - Car And Pedestrain Tracker
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "car_and_pedestrain_tracker"
pytestmark = []
