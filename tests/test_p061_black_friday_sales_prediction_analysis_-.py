"""
Tests for: Machine Learning Project 61 - Black Friday Sales Prediction Analysis - Regression
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "black_friday_sales_prediction_analysis_-_regression"
pytestmark = []
