"""
Tests for: Machine Learning Projects 82 - Marketing Campaign Result Prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "marketing_campaign_result_prediction"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "marketing_campaign.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "marketing_campaign.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "marketing_campaign.csv", encoding="latin-1")
