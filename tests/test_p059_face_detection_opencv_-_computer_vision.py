"""
Tests for: Machine Learning Project 59 - Face Detection (OpenCV) - Computer Vision
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "face_detection_opencv_-_computer_vision"
pytestmark = []
