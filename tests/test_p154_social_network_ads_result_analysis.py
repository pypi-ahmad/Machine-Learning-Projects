"""
Tests for: Machine Learning Projects 154 - Social Network Ads Result Analysis
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "social_network_ads_result_analysis"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Social_Network_Ads.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "Social_Network_Ads.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "Social_Network_Ads.csv", encoding="latin-1")
