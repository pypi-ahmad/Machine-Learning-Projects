"""
Tests for: Machine Learning Projects 75 - Stock Market Analysis for Tech Stocks
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "stock_market_analysis_for_tech_stocks"
pytestmark = []
