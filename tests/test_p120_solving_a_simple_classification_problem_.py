"""
Tests for: Machine Learning Projects 120 - Solving A Simple Classification Problem with Python
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "solving_a_simple_classification_problem_with_python"
pytestmark = []
...
class TestModelTraining:
    ...
    def test_decisiontreeclassifier_fit(self):
