"""
Tests for: Machine Learning Project 65 - Heart Disease Prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "heart_disease_prediction"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "heart.csv", encoding="latin-1")
