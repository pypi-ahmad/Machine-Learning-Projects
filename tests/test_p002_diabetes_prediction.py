"""
Tests for: Project 2- Diabetes Prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "diabetes_prediction"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "diabetes.csv", encoding="latin-1")
