"""
Tests for: Machine Learning Project 57 - Iris dataset analysis - Classification
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "iris_dataset_analysis_-_classification"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "Iris.csv", encoding="latin-1")
