"""
Tests for: Machine Learning Projects 112 - (Conceptual) nhanes_hypothesis_testing
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "conceptual_nhanes_hypothesis_testing"
pytestmark = []
