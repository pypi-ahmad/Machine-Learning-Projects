"""
Tests for: Machine Learning Projects 70 - 3-Way Sentiment Analysis for Tweets
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "3-way_sentiment_analysis_for_tweets"
pytestmark = []
