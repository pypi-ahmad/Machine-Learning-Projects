"""
Tests for: Machine Learning Project 43 - Wine Quality Prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "wine_quality_prediction"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "winequality-red.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "winequality-red.csv", encoding="latin-1")
