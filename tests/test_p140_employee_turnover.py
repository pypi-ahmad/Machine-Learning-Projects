"""
Tests for: Machine Learning Projects 140 - Employee_Turnover
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "employee_turnover"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "HR_comma_sep.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "HR_comma_sep.csv", encoding="latin-1")
