"""
Tests for: Machine Learning Project 14 - Fraud Detection Using ML
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "fraud_detection_using_ml"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "payment_fraud.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "payment_fraud.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "payment_fraud.csv", encoding="latin-1")
