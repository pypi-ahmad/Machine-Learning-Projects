"""
Tests for: Machine Learning Project 33 - (Conceptual Analysis) Select Right Threhold Value using ROC curve
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "conceptual_analysis_select_right_threhold_value_using_roc_curve"
pytestmark = []
