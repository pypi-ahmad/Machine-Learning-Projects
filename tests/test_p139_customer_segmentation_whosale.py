"""
Tests for: Machine Learning Projects 139 - Customer_Segmentation_Whosale
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "customer_segmentation_whosale"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Wholesale customers data.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "Wholesale customers data.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "Wholesale customers data.csv", encoding="latin-1")
