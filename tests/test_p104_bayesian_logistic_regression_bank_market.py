"""
Tests for: Machine Learning Projects 104 - Bayesian Logistic Regression_bank marketing
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "bayesian_logistic_regression_bank_marketing"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "BankChurners.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "BankChurners.csv", encoding="latin-1")
