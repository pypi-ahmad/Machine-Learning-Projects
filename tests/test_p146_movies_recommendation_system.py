"""
Tests for: Machine Learning Projects 146 - Movies Recommendation system
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "movies_recommendation_system"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "movies.csv", encoding="latin-1")
