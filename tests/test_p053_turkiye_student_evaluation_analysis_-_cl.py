"""
Tests for: Machine Learning Project 53 - Turkiye Student Evaluation Analysis - Clustering
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "turkiye_student_evaluation_analysis_-_clustering"
pytestmark = []
