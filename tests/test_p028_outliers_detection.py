"""
Tests for: Machine Learning Project 28 - Outliers Detection
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "outliers_detection"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "titanic.csv", encoding="latin-1")
