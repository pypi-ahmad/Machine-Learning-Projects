"""
Tests for: Machine Learning Project  84 - Sentiment Analysis - Dow Jones (DJIA) Stock using News Headlines
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "sentiment_analysis_-_dow_jones_djia_stock_using_news_headlines"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Stock Headlines.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "Stock Headlines.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "Stock Headlines.csv", encoding="latin-1")
