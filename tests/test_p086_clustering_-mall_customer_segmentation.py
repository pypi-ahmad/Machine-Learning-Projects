"""
Tests for: Machine Learning Projects  86 - Clustering -Mall Customer Segmentation
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "clustering_-mall_customer_segmentation"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Mall_Customers.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "Mall_Customers.csv", encoding="latin-1")
