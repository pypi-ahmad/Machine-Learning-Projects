"""
Tests for: Machine Learning Projects  91 - Text Summarization using Word Frequency - NLP
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "text_summarization_using_word_frequency_-_nlp"
pytestmark = []
