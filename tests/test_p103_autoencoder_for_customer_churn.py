"""
Tests for: Machine Learning Projects 103 - Autoencoder for customer churn
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "autoencoder_for_customer_churn"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "WA_Fn-UseC_-Telco-Customer-Churn.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "WA_Fn-UseC_-Telco-Customer-Churn.csv", encoding="latin-1")
