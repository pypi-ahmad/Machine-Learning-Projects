"""
Tests for: Machine Learning Projects 110 - Modeling House Price with Regularized Linear Model _ Xgboos
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "modeling_house_price_with_regularized_linear_model___xgboos"
pytestmark = []
