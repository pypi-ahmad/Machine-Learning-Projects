"""
Tests for: Machine Learning Project 51 - Bigmart Sales Prediction Analysis - Regression
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "bigmart_sales_prediction_analysis_-_regression"
pytestmark = []
