"""
Tests for: Machine Learning Project 50 - 50_startups Success Rate Prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "50_startups_success_rate_prediction"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "50_Startups.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "50_Startups.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "50_Startups.csv", encoding="latin-1")
