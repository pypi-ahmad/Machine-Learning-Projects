"""
Tests for: Machine Learning Projects 71 - 911 Calls - Exploratory Analysis
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "911_calls_-_exploratory_analysis"
pytestmark = []
