"""
Tests for: Machine Learning Projects 145 - Machine Learning for Diabetes
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "machine_learning_for_diabetes"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "diabetes2.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "diabetes2.csv", encoding="latin-1")
