"""
Tests for: Machine Learning Project 63 - Data Scientist's Salary Prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "data_scientists_salary_prediction"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "glassdoor_jobs.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "glassdoor_jobs.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "glassdoor_jobs.csv", encoding="latin-1")
