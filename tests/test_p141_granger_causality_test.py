"""
Tests for: Machine Learning Projects 141 - Granger Causality Test
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "granger_causality_test"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "AAPL.csv", encoding="latin-1")
