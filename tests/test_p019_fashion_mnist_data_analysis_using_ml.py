"""
Tests for: Machine Learning Project 19 - Fashion Mnist Data Analysis Using ML
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "fashion_mnist_data_analysis_using_ml"
pytestmark = []
