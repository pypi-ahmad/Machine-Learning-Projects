"""
Tests for: Machine Learning Project 54 - Traffic Forecast - Time Series Analysis
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "traffic_forecast_-_time_series_analysis"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Traffic data.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "Traffic data.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "Traffic data.csv", encoding="latin-1")
