"""
Tests for: Machine Learning Project 45 - Customer Segmentation
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "customer_segmentation"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "Customers.csv", encoding="latin-1")
