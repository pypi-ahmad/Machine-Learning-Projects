"""
Tests for: Machine Learning Project 15 - Forecasting using ARIMA
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "forecasting_using_arima"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "perrin-freres-monthly-champagne-.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "perrin-freres-monthly-champagne-.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "perrin-freres-monthly-champagne-.csv", encoding="latin-1")
