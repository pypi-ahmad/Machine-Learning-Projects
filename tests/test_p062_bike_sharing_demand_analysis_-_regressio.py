"""
Tests for: Machine Learning Project 62 - Bike Sharing Demand Analysis - Regression
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "bike_sharing_demand_analysis_-_regression"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "hour.csv", encoding="latin-1")
