"""
Tests for: Machine Learning Project 55 - Million Songs Dataset - Recommendation Engine
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "million_songs_dataset_-_recommendation_engine"
pytestmark = []
