"""
Tests for: Machine Learning Project 8- House_Price_Prediction Detailed Analysis
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "house_price_prediction_detailed_analysis"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "test.csv", encoding="latin-1")
