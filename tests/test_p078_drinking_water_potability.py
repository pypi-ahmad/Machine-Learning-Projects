"""
Tests for: Machine Learning Projects 78 - Drinking Water Potability
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "drinking_water_potability"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "water_potability.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "water_potability.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "water_potability.csv", encoding="latin-1")
