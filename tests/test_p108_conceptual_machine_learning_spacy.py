"""
Tests for: Machine Learning Projects 108 - (Conceptual) machine learning spaCy
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "conceptual_machine_learning_spacy"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "research_paper.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "research_paper.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "research_paper.csv", encoding="latin-1")
