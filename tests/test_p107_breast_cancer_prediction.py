"""
Tests for: Machine Learning Projects 107 - breast_cancer_prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "breast_cancer_prediction"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Wisconsin-bc-data.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "Wisconsin-bc-data.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "Wisconsin-bc-data.csv", encoding="latin-1")
