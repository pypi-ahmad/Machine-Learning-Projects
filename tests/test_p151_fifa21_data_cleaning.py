"""
Tests for: Machine Learning Projects 151 -  fifa21_Data Cleaning
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "fifa21_data_cleaning"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "fifa21.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "fifa21.csv", encoding="latin-1")
