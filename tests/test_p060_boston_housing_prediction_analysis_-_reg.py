"""
Tests for: Machine Learning Project 60 - Boston Housing Prediction Analysis - Regression
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "boston_housing_prediction_analysis_-_regression"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Boston Dataset.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "Boston Dataset.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "Boston Dataset.csv", encoding="latin-1")
