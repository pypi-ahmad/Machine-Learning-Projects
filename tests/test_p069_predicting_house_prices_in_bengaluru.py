"""
Tests for: Machine Learning Project 69 - Predicting House Prices in Bengaluru
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "predicting_house_prices_in_bengaluru"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Bengaluru_House_Data.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "Bengaluru_House_Data.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "Bengaluru_House_Data.csv", encoding="latin-1")
