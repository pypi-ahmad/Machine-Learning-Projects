"""
Tests for: Machine Learning Project 10 - Titanic Problem Handling Missing Values
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "titanic_problem_handling_missing_values"
pytestmark = []
