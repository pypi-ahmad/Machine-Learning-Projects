"""
Tests for: Machine Learning Project 66 - First Innings Score Prediction - IPL
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "first_innings_score_prediction_-_ipl"
pytestmark = []
