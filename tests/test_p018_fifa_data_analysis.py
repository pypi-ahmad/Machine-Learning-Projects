"""
Tests for: Machine Learning Project 18 - FIFA Data Analysis
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "fifa_data_analysis"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "data.csv", encoding="latin-1")
