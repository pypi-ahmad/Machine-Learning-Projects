"""
Tests for: Machine Learning Project 56 - Loan Prediction Analysis - Classification
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "loan_prediction_analysis_-_classification"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Loan Prediction Dataset.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "Loan Prediction Dataset.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "Loan Prediction Dataset.csv", encoding="latin-1")
