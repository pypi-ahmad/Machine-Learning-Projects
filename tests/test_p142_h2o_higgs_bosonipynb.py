"""
Tests for: Machine Learning Projects 142 - H2O Higgs Boson.ipynb
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "h2o_higgs_bosonipynb"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "training.csv", encoding="latin-1")
