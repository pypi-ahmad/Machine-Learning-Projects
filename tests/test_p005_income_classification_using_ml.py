"""
Tests for: Machine Learning Project 5 - Income Classification using ML
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "income_classification_using_ml"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "income_evaluation.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "income_evaluation.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "income_evaluation.csv", encoding="latin-1")
