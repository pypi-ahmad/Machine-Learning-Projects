"""
Tests for: Machine Learning Project 22 - Employee Turnover Prediction
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "employee_turnover_prediction"
pytestmark = []
