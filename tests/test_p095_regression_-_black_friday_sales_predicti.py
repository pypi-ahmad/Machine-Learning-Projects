"""
Tests for: Machine Learning Projects 95 - Regression - Black Friday Sales Prediction Analysis
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "regression_-_black_friday_sales_prediction_analysis"
pytestmark = []
