"""
Tests for: Machine Learning Projects 149 - Twitter Sentiment Analysis - NLP
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "twitter_sentiment_analysis_-_nlp"
pytestmark = []
