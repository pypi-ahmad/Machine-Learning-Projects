"""
Tests for: Machine Learning Projects 122 - (Conceptual) Supervised Learning - Part I
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "conceptual_supervised_learning_-_part_i"
pytestmark = []
