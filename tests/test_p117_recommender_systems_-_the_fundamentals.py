"""
Tests for: Machine Learning Projects 117 - Recommender Systems - The Fundamentals
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "recommender_systems_-_the_fundamentals"
pytestmark = []
