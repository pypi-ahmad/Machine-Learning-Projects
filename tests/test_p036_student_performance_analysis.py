"""
Tests for: Machine Learning Project 36 - Student Performance Analysis
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "student_performance_analysis"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "StudentsPerformance.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        try:
            ...
            df = pd.read_csv(DATA_DIR / "StudentsPerformance.csv", encoding="latin-1")
