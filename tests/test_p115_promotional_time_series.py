"""
Tests for: Machine Learning Projects 115 - Promotional Time Series
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "promotional_time_series"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "Sales_Product_Price_by_Store.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "Sales_Product_Price_by_Store.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "Sales_Product_Price_by_Store.csv", encoding="latin-1")
