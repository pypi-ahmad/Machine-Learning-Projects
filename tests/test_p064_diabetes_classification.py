"""
Tests for: Machine Learning Project 64 - Diabetes Classification
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "diabetes_classification"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_data_file_exists(self):
        ...
        fpath = DATA_DIR / "kaggle_diabetes.csv"
        if not fpath.exists():
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "kaggle_diabetes.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "kaggle_diabetes.csv", encoding="latin-1")
