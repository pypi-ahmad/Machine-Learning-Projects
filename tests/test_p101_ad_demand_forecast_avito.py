"""
Tests for: Machine Learning Projects 101 - Ad Demand Forecast Avito
...
DATA_DIR = Path(__file__).resolve().parent.parent / "data" / "ad_demand_forecast_avito"
pytestmark = []
...
class TestDataLoading:
    ...
    def test_load_without_error(self):
        ...
        if not fpath.exists():
            pytest.skip(f"Data file not found: {fpath}")
        try:
            df = pd.read_csv(DATA_DIR / "param_1.csv")
        except (UnicodeDecodeError, ValueError):
            df = pd.read_csv(DATA_DIR / "param_1.csv", encoding="latin-1")
