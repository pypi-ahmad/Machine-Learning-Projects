...
```powershell
uv sync
uv run python "Python Scripts/Chat bot/Personal Finance Chatbot/run.py" --mode smoke
uv run python "Python Scripts/Chat bot/Personal Finance Chatbot/run.py" --mode full
uv run python "Python Scripts/Chat bot/Personal Finance Chatbot/run.py" --download-only
uv run python "Python Scripts/Chat bot/Personal Finance Chatbot/run.py" --epochs 10
uv run python "Python Scripts/Chat bot/Personal Finance Chatbot/run.py" --device cpu
uv run python "Python Scripts/Chat bot/Personal Finance Chatbot/run.py" --no-amp
```
...
This learning project classifies finance-related intent labels only. It does not provide financial advice or recommendations and must not be used as the basis for financial decisions.
