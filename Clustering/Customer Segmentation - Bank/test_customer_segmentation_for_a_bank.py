"""
Auto-generated tests for: Clustering/1 Customer segmentation for a bank
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/customer_segmentation_bank/german_credit_data.csv")
