#!/usr/bin/env python3
"""
Model evaluation for 3 Online retail customer segmentation
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Model evaluation for 3 Online retail customer segmentation")
