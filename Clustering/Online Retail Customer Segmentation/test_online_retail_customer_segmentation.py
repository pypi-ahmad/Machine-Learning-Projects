"""
Auto-generated tests for: Clustering/3 Online retail customer segmentation
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/online_retail_segmentation/data.csv")
