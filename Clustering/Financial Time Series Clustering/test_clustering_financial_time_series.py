"""
Auto-generated tests for: Clustering/9 Clustering financial time series
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/clustering_financial_time_series/all_stocks_5yr.csv")
