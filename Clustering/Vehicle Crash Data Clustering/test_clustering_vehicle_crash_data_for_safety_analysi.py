"""
Auto-generated tests for: Clustering/10 clustering vehicle crash data for safety analysi
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/vehicle_crash_clustering/RTA Dataset.csv")
