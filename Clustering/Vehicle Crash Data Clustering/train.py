#!/usr/bin/env python3
"""
Model training for 10 clustering vehicle crash data for safety analysi
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Model training for 10 clustering vehicle crash data for safety analysi")
