"""
Auto-generated tests for: Clustering/8 wholesale customer segmentation
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/wholesale_customer_segmentation/Wholesale customers data.csv")
