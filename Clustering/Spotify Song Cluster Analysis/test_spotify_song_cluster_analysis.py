"""
Auto-generated tests for: Clustering/7 spotify song cluster analysis
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/spotify_song_cluster/top50.csv")
