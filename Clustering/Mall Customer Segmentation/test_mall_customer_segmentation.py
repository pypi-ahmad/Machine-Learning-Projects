"""
Auto-generated tests for: Clustering/4 Mall customer segmentation
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/mall_customer_segmentation/Mall_Customers.csv")
