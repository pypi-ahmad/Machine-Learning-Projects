"""
Auto-generated tests for: Clustering/2 Credit Card customer segmentation
...
DATA_PATH = os.path.join(os.path.dirname(__file__), "../../data/credit_card_segmentation/CC GENERAL.csv")
