#!/usr/bin/env python3
"""
Model evaluation for 2 Credit Card customer segmentation
...
if __name__ == "__main__":
    ...
    _parser = _ap.ArgumentParser(description="Model evaluation for 2 Credit Card customer segmentation")
