...
def load_data():
    ...
    df = pd.read_csv("https://raw.githubusercontent.com/dsrscientist/dataset3/refs/heads/master/Placement_Data_Full_Class.csv", sep=",")
...
def train_and_evaluate(X_train, X_test, y_train, y_test):
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            predictor = TabularPredictor(label="status", path=tmp, verbosity=1)
