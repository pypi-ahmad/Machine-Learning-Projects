...
# Remove old file
Path("Fashion MNIST Autoencoder.ipynb").unlink(missing_ok=True)
...
with open("Fashion MNIST Autoencoder.ipynb", "w", encoding="utf-8") as f:
    nbf.write(nb, f)
print("Notebook created with UTF-8 encoding")
