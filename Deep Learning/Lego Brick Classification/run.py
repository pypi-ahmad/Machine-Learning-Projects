#!/usr/bin/env python3
"""
Project 36 -- Lego Brick Classification
...
def get_data():
    ...
    # Prefer 'LEGO brick images v1' (has class subdirs)
    lego_v1 = DATA_DIR / "LEGO brick images v1"
    if lego_v1.is_dir():
        return lego_v1
    for child in sorted(DATA_DIR.iterdir()):
        if child.is_dir() and child.name not in ("__MACOSX", "__pycache__", "Collada models", "dataset"):
            return child
    return DATA_DIR
