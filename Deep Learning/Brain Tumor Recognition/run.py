#!/usr/bin/env python3
"""
Project 20 -- Brain Tumor Classification
...
def get_data():
    ...
    # Dataset has brain_tumor_dataset/{yes,no}/ class layout
    bts = DATA_DIR / "brain_tumor_dataset"
    if bts.is_dir():
        return bts
    # Fallback: DATA_DIR itself may have class dirs (yes/, no/)
    return DATA_DIR
