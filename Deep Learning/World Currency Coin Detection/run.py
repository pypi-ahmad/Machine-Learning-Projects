#!/usr/bin/env python3
"""
Project 34 -- World Currency Coin Classification
...
def get_data():
    ...
    # Dataset extracts to coins/data/{train,test}/{class}/
    nested = DATA_DIR / "coins" / "data"
    if nested.is_dir():
        return nested
    # Fallback: search for dir containing train/
    for d in DATA_DIR.rglob("train"):
        if d.is_dir() and d.parent != DATA_DIR:
            return d.parent
    return DATA_DIR
