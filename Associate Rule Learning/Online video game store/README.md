# Online Video Game Store Association Rule Learning

## Documentation
- [Online video game store.pdf](Online%20video%20game%20store.pdf)
...
## Approach
Apriori and FP-Growth algorithms (mlxtend) to extract association rules from eCommerce purchase behavior data.
